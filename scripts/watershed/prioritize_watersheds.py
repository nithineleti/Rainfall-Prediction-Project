#!/usr/bin/env python
"""
scripts/watershed/prioritize_watersheds.py
...
Outputs (data/vectors/, data/tables/, outputs/reports/):
...
Prerequisites:
    - scripts/watershed/characterize_watersheds.py (watersheds with extracted statistics)
"""
import os
import sys
...
from path_config import VECTORS_DIR, TABLES_DIR, REPORTS_DIR, WATERSHEDS_CHARACTERIZED, WATERSHEDS_PRIORITIZED

# Paths
WATERSHEDS_CHAR_FILE = str(WATERSHEDS_CHARACTERIZED)
WATERSHEDS_CHAR_CSV = str(TABLES_DIR / "watersheds_characterized.csv")
OUT_DIR = str(VECTORS_DIR)

# Outputs
OUT_SHP = str(WATERSHEDS_PRIORITIZED)
OUT_CSV = str(TABLES_DIR / "watersheds_prioritized.csv")
OUT_SUMMARY = str(REPORTS_DIR / "priority_summary.txt")
