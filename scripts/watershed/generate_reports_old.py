#!/usr/bin/env python
"""
src/generate_watershed_reports.py
...
Prerequisites:
    - src/prioritize_watersheds.py (watersheds with priority scores)
"""
import os
import numpy as np
import pandas as pd
...
# Paths
WATERSHEDS_PRIOR_FILE = "data/processed/stage4/watersheds_prioritized.shp"
WATERSHEDS_PRIOR_CSV = "data/processed/stage4/watersheds_prioritized.csv"
OUT_DIR = "data/processed/stage4"

# Outputs
OUT_PDF = os.path.join(OUT_DIR, "Executive_Summary.pdf")
OUT_EXCEL = os.path.join(OUT_DIR, "Watershed_Action_Plans.xlsx")
