...
# Paths
WATERSHEDS_FILE = "data/processed/stage4/watershed_boundaries_lucknow.shp"
...
DRAINAGE_DENS_FILE = "data/processed/stage3/drainage_density_lucknow.tif"
STREAM_FILE = "data/processed/stage3/stream_network_lucknow.tif"

# Groundwater potential (try ML first, fallback to AHP)
GWP_ML_FILE = "data/processed/stage4/gwp_score_ml.tif"
GWP_AHP_FILE = "data/processed/grp_score_lucknow.tif"

# Optional layers
GEOLOGY_FILE = "data/processed/stage3/geology_lucknow.tif"
NDVI_FILE = "data/processed/stage3/ndvi_mean_lucknow.tif"

# Outputs
OUT_SHP = os.path.join(OUT_DIR, "watersheds_characterized.shp")
OUT_CSV = os.path.join(OUT_DIR, "watersheds_characterized.csv")
