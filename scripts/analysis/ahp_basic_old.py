...
What it does:
- Reads processed rasters from data/processed/
    - REQUIRED: slope_lucknow.tif
    - OPTIONAL: soil_perm_lucknow.tif, lulc_lucknow.tif, mean_annual_rain_lucknow.tif
...
- Produces:
    - data/processed/grp_score_lucknow.tif  (continuous score 0-1)
    - data/processed/grp_class_lucknow.tif  (0=Low,1=Moderate,2=High)
    - data/processed/grp_class_lucknow.shp  (polygonized shapefile)
Notes:
...
SLOPE = os.path.join(IN_DIR, "slope_lucknow.tif")
SOIL = os.path.join(IN_DIR, "soil_perm_lucknow.tif")          # optional
LULC = os.path.join(IN_DIR, "lulc_lucknow.tif")               # optional
RAIN = os.path.join(IN_DIR, "mean_annual_rain_lucknow.tif")   # optional
