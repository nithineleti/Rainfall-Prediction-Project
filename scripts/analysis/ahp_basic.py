...
- Produces:
    ...
    - outputs/predictions/grp_class_lucknow.shp  (polygonized shapefile)
Notes:
...
from path_config import RASTERS_DIR, PREDICTIONS_DIR, SLOPE, LULC, RAINFALL
...
GRP_SHP = str(PREDICTIONS_DIR / "grp_class_lucknow.shp")
