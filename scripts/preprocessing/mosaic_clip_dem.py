...
DEM_BASE_DIR = "data/raw"

# Path to Lucknow district shapefile
SHAPEFILE_PATH = r"G:\PROJECTS\watershed-up\data\raw\lucknow_shp\lucknow.shp"  # Update this path

# Output paths
MOSAIC_OUTPUT = "data/processed/mosaic_dem.tif"
CLIPPED_OUTPUT = "data/processed/lucknow_dem_clipped.tif"
