...
Usage (synthetic):
    python src/sample_wells.py --stack data/processed/stage3/features_stack.tif \
        --out data/processed/stage4/train_samples.csv --n 2000 --mode synthetic
...
OUT_DIR_DEFAULT = "data/processed/stage4"
