...
from path_config import TRAIN_SAMPLES_CSV, FEATURES_BANDS_CSV, PREDICTIONS_DIR

DEFAULT_TRAIN_CSV = str(TRAIN_SAMPLES_CSV)
DEFAULT_BANDCSV = str(FEATURES_BANDS_CSV)
