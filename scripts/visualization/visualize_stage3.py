...
Outputs:
 - data/processed/stage3/figs/<layer>.png
 - data/processed/stage3/features_summary.csv
 - data/processed/stage3/features_corr.csv  (continuous bands only)
"""
...
# Paths
STACK_PATH = "data/processed/stage3/features_stack.tif"
BANDS_CSV = "data/processed/stage3/features_stack_bands.csv"
OUT_DIR = "data/processed/stage3/figs"
os.makedirs(OUT_DIR, exist_ok=True)

SUMMARY_CSV = "data/processed/stage3/features_summary.csv"
CORR_CSV = "data/processed/stage3/features_corr.csv"
