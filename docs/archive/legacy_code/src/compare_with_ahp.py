...
import pandas as pd
from path_config import PREDICTIONS_DIR, RASTERS_DIR

ml_class = os.path.join(str(PREDICTIONS_DIR), "predicted_grp_class.tif")
ahp_class = os.path.join(str(RASTERS_DIR), "grp_class_lucknow.tif")   # original AHP class from stage2
