...
Outputs:
 - data/rasters/grp_score_lucknow.tif (0-1)
 - data/rasters/grp_class_lucknow.tif (0 low,1 med,2 high)
 - data/rasters/grp_class_lucknow.shp
Usage:
...
from path_config import SLOPE, LULC, RASTERS_DIR
